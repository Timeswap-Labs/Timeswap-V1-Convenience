...
import { newLiquidityFixture, constructorFixture, Fixture, lendGivenBondFixture, lendGivenInsuranceFixture } from '../shared/Fixtures'
      ...
      fc.asyncProperty(
        ...
        async (data) => {
          const success = async () => {
            ...
            const lendGivenBond = await lendGivenInsuranceFixture(newLiquidity, signers[0], data.lendGivenInsuranceParams)
          ...
          const delState = { x: data.lendGivenInsuranceParams.assetIn, y: yDecreaseLendGivenBond, z: zDecreaseLendGivenBond }
