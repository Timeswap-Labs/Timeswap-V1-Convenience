...
import { Claims, CollectParams } from "../test-cases/types";
...
export class Convenience {
    ...
    constructor(convenienceContract: ConvenienceContract, factoryContract: FactoryContract,signer: SignerWithAddress){
     ...
     async newLiquidity(maturity:bigint,asset:string,collateral:string, assetIn:bigint,debtIn:bigint,collateralIn:bigint) {
     ...
     async addLiquidity(maturity:bigint,asset:string,collateral:string, assetIn:bigint,minLiquidity:bigint,maxDebt:bigint,maxCollateral:bigint) {
    ...
    async lendGivenBond(maturity: bigint, asset:string, collateral:string,assetIn: bigint, bondOut:bigint, minInsurance:bigint){
    ...
    async lendGivenInsurance(maturity: bigint, asset:string, collateral:string,assetIn: bigint, insuranceOut:bigint, minBond:bigint){
  ...
  async lendGivenPercent(maturity: bigint, asset:string, collateral:string,assetIn: bigint, minInsurance:bigint, minBond:bigint,percent:bigint){
...
async borrowGivenDebt(maturity: bigint, asset: string, collateral: string, assetOut: bigint, debtIn: bigint, maxCollateral: bigint) {
  ...
  async borrowGivenCollateral(maturity: bigint, asset: string, collateral: string, assetOut: bigint, maxDebt: bigint, collateralIn: bigint) {
  ...
  async borrowGivenPercent(maturity: bigint, asset: string, collateral: string, assetOut: bigint, maxDebt: bigint, maxCollateral: bigint,percent:bigint) {
...
export async function convenienceInit(maturity: bigint, asset: TestToken, collateral: TestToken, signerWithAddress: SignerWithAddress) {
