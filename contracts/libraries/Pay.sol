...
library Pay {
    ...
    function _pay(
        ...
        IDue collateralizedDebt = natives[params.asset][params.collateral][params.maturity].collateralizedDebt; // Need check for existence // move this after get pair for code consistency
