...
contract ERC721Permit is InterfaceERC721Permit, ERC721 {
    ...
    bytes32 public constant override PERMIT_TYPEHASH = keccak256("Permit(address approved,uint256 tokenId,uint256 nonce,uint256 deadline)");
    ...
    function permit(address _approved, uint256 _tokenId, uint256 _deadline, uint8 _v, bytes32 _r, bytes32 _s) external override {
        ...
        require(_owner == msg.sender || _isApprovedForAll[_owner][msg.sender], "ERC721Permit :: permit : Approve caller is not owner nor approved for all");
